...
export class Backend implements backendInterface {
    ...
    async createInquiry(arg0: string, arg1: string, arg2: string | null, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createInquiry(arg0, arg1, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg2), arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
